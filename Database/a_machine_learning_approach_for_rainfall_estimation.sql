...
--
-- Host: localhost
-- Generation Time: Aug 01, 2022 at 11:12 AM
...
--
-- Database: `a_machine_learning_approach_for_rainfall_estimation`
--
CREATE DATABASE IF NOT EXISTS `a_machine_learning_approach_for_rainfall_estimation` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_machine_learning_approach_for_rainfall_estimation`;
...
('2izu1hlj6rsjd33y3cqyk3ja01rqxp9o', 'eyJ1c2VyaWQiOjF9:1oIPDa:7hWMd4JcnQZeqWFcBcRjBn7iUcMWLEtr3Qqg-trMAe8', '2022-08-15 06:47:58.560318'),
...
('q4105uzhqd3ce7cqt2jb6zkpokhpz66a', 'eyJ1c2VyaWQiOjJ9:1oITGp:ux4lac1rI6tlUIfJvkpbranapXxl9hdTg-YPpclXluU', '2022-08-15 11:07:35.346157'),
...
(1, 'Arun', 'Arun123@gmail.com', 'Arun', '9535866270', 'India', 'Karnataka', 'Bangalore', '#872,4th Cross,Vijayanagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,rRajajinagar', 'Male');
...
(76, 'Naive Bayes', '71.55348294957739'),
(77, 'SVM', '71.55348294957739'),
(78, 'Logistic Regression', '71.58262897114544'),
(79, 'SGD Classifier', '71.55348294957739');
...
(12, 'No Rainfall', '33.33333333333333'),
(13, 'Heavy Rainfall', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_rainfall_estimation`
--

CREATE TABLE IF NOT EXISTS `remote_user_rainfall_estimation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Date1` varchar(300) NOT NULL,
  `Location` varchar(300) NOT NULL,
  `MinTemp` varchar(300) NOT NULL,
  `MaxTemp` varchar(300) NOT NULL,
  `Rainfall` varchar(300) NOT NULL,
  `Evaporation` varchar(300) NOT NULL,
  `Sunshine` varchar(300) NOT NULL,
  `WindGustDir` varchar(300) NOT NULL,
  `WindGustSpeed` varchar(300) NOT NULL,
  `WindDir` varchar(300) NOT NULL,
  `WindSpeed` varchar(300) NOT NULL,
  `Humidity` varchar(300) NOT NULL,
  `Pressure` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_rainfall_estimation`
--

INSERT INTO `remote_user_rainfall_estimation` (`id`, `Date1`, `Location`, `MinTemp`, `MaxTemp`, `Rainfall`, `Evaporation`, `Sunshine`, `WindGustDir`, `WindGustSpeed`, `WindDir`, `WindSpeed`, `Humidity`, `Pressure`, `Cloud`, `Temp`, `idnumber`, `Prediction`) VALUES
(1, '29-12-20', 'Hydrabad', '19.7', '27.2', '0', 'NA', 'NA', 'WNW', '46', 'WSW', '19', '49', '1004.8', 'NA', '21.6', '[''RFRNO65508'']', 'Heavy Rainfall'),
(2, '10-01-20', 'Hydrabad', '17', '30.8', '0', 'NA', 'NA', 'NE', '37', 'E', '15', '36', '1013.4', 'NA', '20.2', '[''RFRNO1229'']', 'No Rainfall'),
(3, '08-07-12', 'Bangalore', '5.9', '18.2', '0', 'NA', 'NA', 'NE', '19', 'N', '4', '97', '1031.5', 'NA', '9.4', '[''70561'']', 'Heavy Rainfall');
